...
//     EXPECT_FLOAT_EQ(copiedVec[3], 0.0f);
// }
...
// {
//     Vector4 v1 = Tuple4Factory::GetTuple4Factory().CreateVector(1.0f, 2.0f, 2.5f);
//     Vector4 v2 = Tuple4Factory::GetTuple4Factory().CreateVector(2.0f, 1.5f, 1.0f);
//     Vector4 v3 = v1 + v2;

//     EXPECT_FLOAT_EQ(v3[0], 3.0f);
//     EXPECT_FLOAT_EQ(v3[1], 3.5f);
//     EXPECT_FLOAT_EQ(v3[2], 3.5f);
//     EXPECT_FLOAT_EQ(v3[3], 0.0f);
// }
...
// {
//     Vector4 v1 = Tuple4Factory::GetTuple4Factory().CreateVector(1.0f, 0.0f, 0.0f);
//     Vector4 v2 = Tuple4Factory::GetTuple4Factory().CreateVector(0.0f, 1.0f, 0.0f);
//     Vector4 v3 = v1 * v2;
...
// {
//     Vector4 testVec = Tuple4Factory::GetTuple4Factory().CreateVector(3.0f, 2.0f, 1.0f);
...
//     EXPECT_FLOAT_EQ(testPoint[3], 1.0f);
// }

// TEST(Vector, VectorScale)
// {
//     const Vector4 v1 = Tuple4Factory::GetTuple4Factory().CreateVector(1.0f, 2.0f, 2.5f);
//     Vector4 v2 = 2.0f * v1;
...
// {
//     Vector4 testVec = Tuple4Factory::GetTuple4Factory().CreateVector(3.0f, 4.0f, 5.0f);
...
// {
//     const Vector4 v1 = Tuple4Factory::GetTuple4Factory().CreateVector(1.0f, 2.0f, 3.0f);
...
// {
//     Vector4 v1 = Tuple4Factory::GetTuple4Factory().CreateVector(1.0f, 2.0f, 3.0f);
//     v1.Normalize();
...
// {
//     Vector4 v1 = Tuple4Factory::GetTuple4Factory().CreateVector(1.0f, 2.0f, 3.0f);
//     Vector4 v2 = Tuple4Factory::GetTuple4Factory().CreateVector(2.0f, 3.0f, 4.0f);
